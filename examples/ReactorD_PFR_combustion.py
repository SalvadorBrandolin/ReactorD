...
PFR = rd.idealreactor.StationaryPFR.set_isothermic_isobaric(
    ...
    molar_flow_in={"methane": 100, "oxygen": 100, "water":0, "carbon dioxide":0},
    )

# Simulation:
solution= PFR.simulate() #Falla la simulacion por un error en el calculo de velocidades de reaccion