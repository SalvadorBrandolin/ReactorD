...
def test_fogler_example_12_2_case2():
    ...
    transversal_area = np.pi * (4 / (16500 / 110)) ** 2 / 4

    reactor = pfr.PFR(
        kinetic=kinetic,
        reactor_length=1 / 1000 / transversal_area,
    ...
    reactor.simulate(1e-6, bc_tol=1e-5, max_nodes=1000)
...
def test_fogler_example_12_5():
    """Fogler 6th ed. example 12.5"""
    def cpa(t, p):
